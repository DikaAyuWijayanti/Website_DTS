<?php 
  ...
  if($eks === '/sekolahDTS/ekstrakulikuler'){
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                  <li>
                    <a class="dropdown-item" href="<?php echo $profile === false ? '../pendidiktenagapendidik/strukturorganisasisekolah.php' : 'strukturorganisasisekolah.php'; ?>">Struktur Organisasi Sekolah &nbsp;
                    <img src="https://img.icons8.com/ios-filled/50/000000/tree-structure.png" width="20" height="20"/></a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="<?php echo $profile === false ? '../pendidiktenagapendidik/kepalasekolah.php' : 'kepalasekolah.php'; ?>">Kepala Sekolah &nbsp;
                    <img src="https://img.icons8.com/pastel-glyph/100/000000/school-director--v2.png" width="20" height="20"/></a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="<?php echo $profile === false ? '../pendidiktenagapendidik/komitesekolah.php' : 'komitesekolah.php'; ?>">Komite Sekolah &nbsp; 
                    <img src="https://img.icons8.com/ios-glyphs/30/000000/room.png" width="20" height="20"/></a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="<?php echo $profile === false ? '../pendidiktenagapendidik/dataguru.php' : 'dataguru.php'; ?>">Data Guru &nbsp; 
                    <img src="https://img.icons8.com/ios-filled/50/000000/teacher.png" width="20" height="20"/></a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="<?php echo $profile === false ? '../pendidiktenagapendidik/datasiswa.php' : 'datasiswa.php'; ?>">Data Siswa &nbsp; 
                    <img src="https://img.icons8.com/ios-glyphs/30/000000/room.png" width="20" height="20"/></a>
                  </li>
                </ul>
              </li>
