...
<html lang="en">
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
      <div class="row">
        <div class="col-md-6">
          <h1 class="display-4">SMA NEGERI 1 </h1>
          <p class="kedua">Kawedanan</p>
...
<!-- End Carousel -->
 ...
 <!-- Text Informasi -->
  ...
  <div class="row row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <h6 class="card-keterangan">Diesnatalis ke-37 tahun SMAN 1 KAWEDANAN</h6>
    ...
    <div class="col">
      <div class="card h-100">
        <img src="images/silat.jpg" class="card-img-top" alt="...">
        <div class="card-body">
          <h5 class="card-title">AKADEMIK</h5>
    ...
    <ul class="list-inline">
      <div class="container">
        ...
        <li class="list-inline-item list-contact">CONTACT INFO <br><br>
          <img src="https://img.icons8.com/doodle/96/000000/google-maps-new.png" width="30" height="30"/> &nbsp; Jl. Raya Genengan-Goranggareng, Kec. Kawedanan, Kab. Magetan, Prop. Jatim<br>
          <img src="https://img.icons8.com/doodle/96/000000/ringing-phone.png" width="30" height="30"/> &nbsp; (0351) 439255<br>
          <img src="https://img.icons8.com/doodle/96/000000/gmail.png" width="30" height="30"/> &nbsp; INFO@SMAN1kAWEDANAN.SCH.ID
        </li>
      </div>
    </ul>
  </footer>
