...
?>
                ...
                <div class="container-fluid">
                  ...
                  <h4><i class="fas fa-graduation-cap"></i> Isilah Data Siswa Sekolah</h4><br>
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return validasiMurid()">
                      ...
                      <div class="form-group mb-2">
                        ...
                        <select name="kelas" id="kelas" class="form-control">
                          ...
                          <option value="10D" <?php echo trim($data['kelas']) == '10D' ? 'selected' : '' ?>>10D</option>
                          ...
                          <option value="11D" <?php echo trim($data['kelas']) == '11D' ? 'selected' : '' ?>>11D</option>
                          ...
                          <option value="12D" <?php echo trim($data['kelas']) == '12D' ? 'selected' : '' ?>>12D</option>
                        </select>
                      </div>
                      <div class="form-group mb-2">
