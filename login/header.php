<?php
    ...
    if($state == 'index'){
        $state1 = 'active';
    }else if($state == 'pejabatsekolah' || $state == 'addpejabat' || $state == 'editpejabat'){
        $state2 = 'active';
    }else if($state == 'dataguru' || $state == 'addguru' || $state == 'editguru'){
        $state3 = 'active';
    }else if($state == 'datasiswa' || $state == 'addsiswa' || $state == 'editdatasiswa'){
        $state4 = 'active';
    }
?>
<!DOCTYPE html>
        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 <?php echo $state2; ?>" href="pejabatsekolah.php"><i class="fas fa-graduation-cap"></i> Data Pejabat Sekolah</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 <?php echo $state3; ?>" href="dataguru.php"><i class="fas fa-chalkboard-teacher"></i> Data Guru</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 <?php echo $state4; ?>" href="datasiswa.php"><i class="fas fa-user-graduate"></i> &nbsp;Data Siswa</a>
                </div>
            </div>
