        ...
        <div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush">
                    ...
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 <?php echo $state2; ?>" href="profile.php"><i class="fas fa-graduation-cap"></i> Profile</a>
                    <a class="list-group-item list-group-item-action list-group-item-light p-3 <?php echo $state3; ?>" href="editprofile.php"><i class="fas fa-chalkboard-teacher"></i> Setting</a>
                </div>
            </div>
