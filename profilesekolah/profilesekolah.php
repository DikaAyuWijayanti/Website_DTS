    ...
    <div class="container">
      ...
      <div class="row">
          <div class="col-md-9 bg-dark">
            <h1 class="text-judul">Selamat Datang <br> di SMAN 1 KAWEDANAN</h1>
            <h4>Profil Sekolah SMAN 1 KAWEDANAN</h4>
            <table class="table">
                <tbody>
                    <tr>
                        <td>Nama sekolah</th>
                        <td>: SMAN 1 KAWEDANAN</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>Alamat</th>
                        <td>: Jl. Raya Genengan-Goranggareng, Kec. Kawedanan, Kab. Magetan, Prop. Jatim</td>
                    </tr>
                    <tr>
                        <td>Telp</th>
                        <td>: (0351) 439255</td>
