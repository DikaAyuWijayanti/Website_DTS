    ...
    <div class="container">
      ...
      <div class="row">
          <div class="col-md-9 bg-dark">
            <h1 class="text-judul">Sambutan Kepala Sekolah</h1>
            <img src="../images/sambutan.jpg" class="rounded-circle img-sambutan" alt="sambutan">
            <h5>Bismillahirohmannirrohim</h5>
            <h5>Assalamualaikum Warahmatullah Wabarakatuh</h5>
            <br>
            <p>Alhamdulillahi robbil alamin kami panjatkan kehadlirat Allah SWT, bahwasannya dengan rahmat dan karunia-Nya lah akhirnya Website sekolah ini dengan alamat www.websiteSekolah/Website Sekolah/ dapat kami perbaharui. Kami mengucapkan selamat datang di Website kami Sekolah Menengah Atas Negeri (SMAN) 1 KAWEDANAN yang saya tujukan untuk seluruh unsur pimpinan, guru, karyawan dan siswa serta khalayak umum guna dapat mengakses seluruh informasi tentang segala profil, aktifitas/kegiatan serta fasilitas sekolah kami.</p>
