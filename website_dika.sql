...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 30, 2021 at 03:20 AM
...
(1, 'Yurischa Aulya', 'Suroboyo', '12A', 'IPS'),
(2, 'Vinka Amalia', 'Pasuruan', '12H', 'MIPA'),
...
(11, 'Akmal Naim Zuai', 'Sidoarjo', '12G', 'MIPA'),
...
(21, 'Anisa Ayunda', 'SumberAsih', '12H', 'MIPA'),
(22, 'Eko Saputra', 'PALEMBANG', 'X-A', 'IPS');
...
(106, 'Endang Puryani,M.Pd', 'Jl.Kembang Sawit No.11', 'P', 'KONTRAK', 'Guru mapel Matematika'),
...
(222, 'Eko Saputra', 'Bogor', 'L', 'PNS', 'TATA USAHA');
...
(212251292, 'Adi', 'Wakil Kepala Sekolah', 827284791, 'Bogor'),
